...
//
//debug($user);
$this->assign('page-breadcrumbroot', $this->Html->link('Administratori', array('controller' => 'users', 'action' => 'index')));
$this->assign('crumb', 'Pregled profila');

$this->assign('title', 'Administratori');
$this->assign('page-title', 'Administratori <small>pregled profila</small>');
                ...
                <div id="panel_overview" class="tab-pane in active">
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="user-left">
                                <div class="center">
                                    <h4><?php echo $user['User']['fullname'] ?></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button class="btn btn-teal btn-block" type="submit">
                                    Ažuriraj <i class="fa fa-arrow-circle-right"></i>
                                </button>
                            </div>
                        </div>
                    </form>
